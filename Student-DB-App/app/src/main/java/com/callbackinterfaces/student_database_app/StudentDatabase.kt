...
abstract class StudentDatabase : RoomDatabase() {
    ...
    private class PopulateDBAsyncTask(database: StudentDatabase?) : AsyncTask<Void?, Void?, Void?>() {
        ...
        protected override fun doInBackground(vararg params: Void?): Void? {
            studentDao.insertStudent(Student("Neelima", "0001", "LTTS-Android Studio"))
            studentDao.insertStudent(Student("Rohini", "0002", "LTTS-Android Studio"))
            ...
            studentDao.insertStudent(Student("Sirisha", "0005", "LTTS-Android Studio"))
            return null
        }
